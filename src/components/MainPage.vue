  ...
  <div class="flex justify-center">
    <div class="mb-3 inline-flex xl:w-6/12">
          ...
          <div class="inline-flex shadow-sm rounded-md divide-x divide-indigo-600">
            <div class="relative z-0 inline-flex shadow-sm rounded-md divide-x divide-indigo-600">
              <div
                ...
                <p class="ml-2.5 py-1.5 text-3xl whitespace-nowrap overflow-hidden font-medium">
                  {{ selected.title }}
                </p>
              </div>
              <ListboxButton
      ...
      <input type="search"
        ...
        id="exampleSearch" placeholder="Type query" v-model="searchText" v-if="selected.id !== 2"
      ...
      <div v-else class="flex flex-nowrap px-3">
        <div class="grid grid-cols-2 mr-1.5">
          ...
          <input type="text" maxlength="5" v-model="min" id="min"
          ...
          <input type="text" maxlength="5" v-model="max" id="max"
      ...
      <RouterLink to="/productGrid"
        class="flex whitespace-nowrap items-center w-80 ml-3 px-auto py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
