    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        ...
        <div class="flex w-full flex-col px-4 py-4">
          ...
          <span class="float-right text-gray-400">{{ product.selectedSubscription }}</span>
          <p class="text-lg font-bold">{{ product.subscriptions.find(sub  => sub.name == product.selectedSubscription).pricePerKilo }}</p>
        </div>
      </div>
      <!-- Other product entries here -->
    </div>
      ...
      <form class="mt-5 grid gap-6">
        <div class="relative">
          ...
          <label
            ...
            for="radio_1">
            <img class="w-14 object-contain" src="https://businessbrainz.com/wp-content/uploads/2022/12/Fedex-logo.png" alt="" />
            <div class="ml-5">
        ...
        <div class="relative">
          ...
          <label
            class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
            for="radio_2">
            <img class="w-14 object-contain" src="https://bestmediainfo.com/uploads/2022/08/1659421847.eKart.jpg" alt="" />
            <div class="ml-5">
              <span class="mt-2 font-semibold">eKart Delivery</span>
    ...
    <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
      ...
      <div class="mt-6 border-t border-b py-2">
        <div class="flex items-center justify-between">
          ...
          <p class="font-semibold text-gray-900">{{ product.subscriptions.find(sub  => sub.name == product.selectedSubscription).pricePerKilo }}</p>
        </div>
      </div>
      <div class="mt-6 flex items-center justify-between">
        <p class="text-sm font-medium text-gray-900">Total</p>
        <p class="text-2xl font-semibold text-gray-900">{{product.subscriptions.find(sub  => sub.name == product.selectedSubscription).pricePerKilo}}</p>
      </div>
    </div>
