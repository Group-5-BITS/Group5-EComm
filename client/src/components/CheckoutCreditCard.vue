<template>
  ...
  <div
    class="relative m-auto h-48 w-80 rounded-xl bg-gradient-to-r from-gray-500 to-gray-400 text-white shadow-2xl transition-transform sm:h-56 sm:w-96 sm:hover:scale-110">
    <div class="absolute top-4 w-full px-8 sm:top-8">
      <div class="flex justify-between">
        <div class="">
          <p class="font-light">Name</p>
          <p class="font-medium tracking-widest">{{props.name}}</p>
        </div>
      ...
      <div class="pt-1">
        ...
        <p class="tracking-more-wider font-medium">{{ cardNumber }}</p>
      </div>
      <div class="pt-4 pr-6 sm:pt-6">
        <div class="flex justify-between">
          ...
          <div class="">
            ...
            <p class="text-base font-medium tracking-widest">{{ props.expiry }}</p>
          </div>

          <div class="">
            <p class="text-xs font-light">CVV</p>
            <p class="tracking-more-wider text-sm font-bold">{{ props.cvv }}</p>
          </div>
        </div>
      </div>
    </div>
...
<script setup>
const props = defineProps(['name', 'cardNumber', 'validFrom', 'expiry', 'cvv'])
</script>
